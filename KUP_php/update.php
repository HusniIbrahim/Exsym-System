...
$course1 = $course2 =$course3 =$course_name = "";
$course1_err = $course2_err =$course3_err =$course_name_err = "";
...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($course1_err) && empty($course2_err)&& empty($course3_err) && empty($course_name_err)){
        ...
        $sql = "UPDATE rel SET course1=?,course2=?,course3=?,course_name=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssi", $param_course1, $param_course2, $param_course3,$param_course_name,$param_id);
